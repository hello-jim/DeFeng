...
namespace DeFeng.DAL
{
    public class Customer_DAL
    {
        ...
        public int UpdateCustomer(Customer customer)
        {
            ...
            try
            {
                var sql = "UPDATE Customer SET [customerName]=@customerName,[contacts]=@contacts,[customerPhone]=@customerPhone,[contactsPhone]=@contactsPhone,[customerMobile]=@customerMobile,[IDCard]=@IDCard,[presentAddress]=@presentAddress,[city]=@city,[district]=@district,[area]=@area,[residentialDistrict]=@residentialDistrict,[customerDemand]=@customerDemand,[customerStatus]=@customerStatus,[customerTransactionType]=@customerTransactionType,[isPrivateCustomer]=@isPrivateCustomer,[isQualityCustomer]=@isQualityCustomer,[isPubliceCustomer]=@isPubliceCustomer,[position]=@position,[houseUseType]=@houseUseType,[houseType]=@houseType,[roomCount]=@roomCount,[hallCount]=@hallCount,[toiletCount]=@toiletCount,[balconyCount]=@balconyCount,[houseSizeFrom]=@houseSizeFrom,[houseSizeTo]=@houseSizeTo,[priceFrom]=@priceFrom,[priceTo]=@priceTo,[source]=@source,[grade]=@grade ,[intention]=@intention,shopArea=@shopArea,[nationality]=@nationality,[floor]=@floor,[orientation]=@orientation,[decorationType]=@decorationType,[housePayType]=@housePayType,[supporting]=@supporting,[commissionPayType]=@commissionPayType,[entrustType]=@entrustType ,[customerType]=@customerType,[shopLocation]=@shopLocation,[industry]=@industry,[totalFloor]=@totalFloor,[wall]=@wall,[electricity]=@electricity,[park]=@park,[landType]=@landType,[OfficeLevel]=@OfficeLevel,[workerCount]=@workerCount,[dormCount]=@dormCount,[officeCount]=@officeCount,[clearingCount]=@clearingCount,[current]=@current,[carPark]=@carPark,[landPlan]=@landPlan,[remarks]=@remarks,[lastUpdateStaff]=@lastUpdateStaff,[lastUpdateDate]=@lastUpdateDate  WHERE ID=@ID";
                var sqlPars = new List<SqlParameter>();
