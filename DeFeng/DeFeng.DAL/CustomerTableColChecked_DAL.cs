...
{
    public class CustomerTableColChecked_DAL
    {
        ...
        public List<CustomerTableColChecked> LoadCustomerTableColChecked()
        {
            ...
            try
            {
                var sql = "SELECT [ID],[colName],[col],[checkedStatus] FROM CustomerTableColChecked";
        ...
        public int ChangeCustomerTableColStatus(CustomerTableColChecked col)
        {
            ...
            try
            {
                var sql = "UPDATE CustomerTableColChecked SET checkedStatus=@status WHERE ID=@ID";
